...
export default {
  ...
  methods: {
    // handle
    handleCreate(){
      return $busServer.accounts.create(this.editForm);
    },
    handleRead(entity){
      return $busServer.accounts.read(entity);
    },
    handleUpdate(){
      return $busServer.accounts.update(this.editForm);
    },
    handleDelete(){
      return $busServer.accounts.delete(this.editForm);
    },
    handleSearch(query){
      return $busServer.accounts.search(this.searchForm, query);
    },
    handleEntities(res){
